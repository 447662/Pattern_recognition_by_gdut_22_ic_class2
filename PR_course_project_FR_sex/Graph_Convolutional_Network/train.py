...
config = {
    ...
    'log_file': 'D:/Graph_Convolutional_Network/training_log.txt',  # 训练日志文件路径
...
# 加载数据
train_data = load_graph_data("D:/Graph_Convolutional_Network/datas/graphs/train")
test_data = load_graph_data("D:/Graph_Convolutional_Network/datas/graphs/test")
